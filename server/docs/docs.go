    ...
    "paths": {
        ...
        "/txyun/sms/AddSmsProject": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "项目名, 备注, 模板ID",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/sms.AddSmsProjectReq"
                        }
                    }
                ],
                "responses": {
